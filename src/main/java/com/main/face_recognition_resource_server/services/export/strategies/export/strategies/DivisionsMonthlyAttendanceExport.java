...
@Service
@ExportStrategyKey(AttendanceExportStrategyType.DIVISIONS_MONTH)
public class DivisionsMonthlyAttendanceExport implements AttendanceExportStrategy<DepartmentAttendanceLineChartDTO> {
    ...
    public DivisionsMonthlyAttendanceExport(ExcelSheetStrategyFactory excelSheetStrategyFactory, ExcelChartStrategyFactory excelChartStrategyFactory) {
        this.excelSheetStrategyFactory = excelSheetStrategyFactory;
        this.excelChartStrategyFactory = excelChartStrategyFactory;
    }

    @Override
    public ByteArrayResource attendanceWorkbook(List<AttendanceExcelDataDTO> attendanceExcelData, List<DepartmentAttendanceLineChartDTO> attendanceChartData, ExportAttendanceOptions exportAttendanceOptions, String timeZone) throws IOException {
        ...
        if (exportAttendanceOptions.isIncludeGraphs())
            attendanceWorkbookBuilder = attendanceWorkbookBuilder.addChart(ExcelChartStrategyType.DEPARTMENT_ATTENDANCE_LINE_CHART, attendanceChartData, timeZone);
