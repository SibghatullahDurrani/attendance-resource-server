...
@Service
@ExportStrategyKey(AttendanceExportStrategyType.MEMBERS_SINGLE_DAY)
public class MembersSingleDayExport implements AttendanceExportStrategy<UserAttendancePieChartDTO> {
    ...
    public MembersSingleDayExport(ExcelSheetStrategyFactory excelSheetStrategyFactory, ExcelChartStrategyFactory excelChartStrategyFactory) {
