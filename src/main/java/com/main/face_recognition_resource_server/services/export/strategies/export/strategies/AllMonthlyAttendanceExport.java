...
@Service
@ExportStrategyKey(AttendanceExportStrategyType.ALL_MONTH)
public class AllMonthlyAttendanceExport implements AttendanceExportStrategy<DepartmentAttendanceLineChartDTO> {
    ...
    public AllMonthlyAttendanceExport(ExcelSheetStrategyFactory excelSheetStrategyFactory, ExcelChartStrategyFactory excelChartStrategyFactory) {
