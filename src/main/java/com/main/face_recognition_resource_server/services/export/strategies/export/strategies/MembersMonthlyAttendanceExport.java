...
@Service
@ExportStrategyKey(AttendanceExportStrategyType.MEMBERS_MONTH)
public class MembersMonthlyAttendanceExport implements AttendanceExportStrategy<UserAttendancePieChartDTO> {
    ...
    public MembersMonthlyAttendanceExport(ExcelSheetStrategyFactory excelSheetStrategyFactory, ExcelChartStrategyFactory excelChartStrategyFactory) {
