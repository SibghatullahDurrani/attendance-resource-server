...
@Service
@ExportStrategyKey(AttendanceExportStrategyType.ALL_SINGLE_DAY)
public class AllSingleDayAttendanceExport implements AttendanceExportStrategy<DepartmentAttendancePieChartDTO> {
    ...
    public AllSingleDayAttendanceExport(ExcelSheetStrategyFactory excelSheetStrategyFactory, ExcelChartStrategyFactory excelChartStrategyFactory) {
