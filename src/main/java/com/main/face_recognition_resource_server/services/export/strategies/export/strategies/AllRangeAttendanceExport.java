...
@Service
@ExportStrategyKey(AttendanceExportStrategyType.ALL_RANGE)
public class AllRangeAttendanceExport implements AttendanceExportStrategy<DepartmentAttendanceLineChartDTO> {
    ...
    public AllRangeAttendanceExport(ExcelSheetStrategyFactory excelSheetStrategyFactory, ExcelChartStrategyFactory excelChartStrategyFactory) {
