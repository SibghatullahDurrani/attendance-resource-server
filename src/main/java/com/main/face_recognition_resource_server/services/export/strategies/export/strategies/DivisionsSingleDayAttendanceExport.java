...
@Service
@ExportStrategyKey(AttendanceExportStrategyType.DIVISIONS_SINGLE_DAY)
public class DivisionsSingleDayAttendanceExport implements AttendanceExportStrategy<DepartmentAttendancePieChartDTO> {
    ...
    public DivisionsSingleDayAttendanceExport(ExcelSheetStrategyFactory excelSheetStrategyFactory, ExcelChartStrategyFactory excelChartStrategyFactory) {
        this.excelSheetStrategyFactory = excelSheetStrategyFactory;
        this.excelChartStrategyFactory = excelChartStrategyFactory;
    }

    @Override
    public ByteArrayResource attendanceWorkbook(List<AttendanceExcelDataDTO> attendanceExcelData, List<DepartmentAttendancePieChartDTO> attendanceChartData, ExportAttendanceOptions exportAttendanceOptions, String timeZone) throws IOException {
        ...
        if (exportAttendanceOptions.isIncludeGraphs())
            attendanceWorkbookBuilder = attendanceWorkbookBuilder.addChart(ExcelChartStrategyType.DEPARTMENT_ATTENDANCE_PIE_CHART, attendanceChartData, timeZone);
