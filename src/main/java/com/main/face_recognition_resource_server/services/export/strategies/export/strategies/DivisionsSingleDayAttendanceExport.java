...
public class DivisionsSingleDayAttendanceExport implements AttendanceExportStrategy<DepartmentAttendancePieChartDTO> {
    ...
    @Override
    public ByteArrayResource attendanceWorkbook(List<AttendanceExcelDataDTO> attendanceExcelData, List<DepartmentAttendancePieChartDTO> attendanceChartData, ExportAttendanceOptions exportAttendanceOptions) throws IOException {
        ...
        if (exportAttendanceOptions.isIncludeGraphs())
            attendanceWorkbookBuilder = attendanceWorkbookBuilder.addChart(ExcelChartStrategyType.DEPARTMENT_ATTENDANCE_PIE_CHART, attendanceChartData);
