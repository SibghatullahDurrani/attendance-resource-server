...
public class LeaveCriteriaRepositoryImpl implements LeaveCriteriaRepository {
  ...
  @Override
  public Page<OrganizationLeaveRecordDTO> getOrganizationLeaves(Specification<Leave> specification, Pageable pageable) {
    CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();

    CriteriaQuery<OrganizationLeaveRecordDTO> criteriaQuery = criteriaBuilder.createQuery(OrganizationLeaveRecordDTO.class);
    ...
    criteriaQuery.select(criteriaBuilder.construct(
            OrganizationLeaveRecordDTO.class,
            root.get("id"),
            root.get("date"),
            root.get("status"),
            root.get("type"),
    ...
    TypedQuery<OrganizationLeaveRecordDTO> query = entityManager.createQuery(criteriaQuery)
            .setFirstResult((int) pageable.getOffset())
            .setMaxResults(pageable.getPageSize());

    List<OrganizationLeaveRecordDTO> data = query.getResultList();
