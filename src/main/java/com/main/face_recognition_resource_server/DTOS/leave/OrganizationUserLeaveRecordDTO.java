...
@NoArgsConstructor
@Data
public class OrganizationUserLeaveRecordDTO {
    private Long id;
    private Long date;
    ...
    OrganizationUserLeaveRecordDTO(Long id, Date date, LeaveStatus leaveStatus, LeaveType leaveType, String firstName, String secondName, String departmentName) {
        this.id = id;
